...
const fetchReviews = async (): Promise<Review[]> => {
    try {
        const response = await axios.get<fetchReviewsResponse>("https://clothica-go-it-prod-team-2-back.onrender.com/api/feedbacks?perPage=10");
...
const ReviewsList = () => {
    ...
    const { data=[], error, isLoading, isError } = useQuery<Review[]>({
        queryKey: ['reviews'],
                        ...
                        <SwiperSlide key={review._id}>
                            <li className={css.listItem}>
                                ...
                                <div className={css.authorContainer}>
                                    ...
                                    <Link href={`/categories/${review.category}`} className={css.link}>{review.category}</Link>
                                </div>
                            </li>
                        </SwiperSlide>
                    ))}
